...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=7853186-oss_labs_reengineering_p_s&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=7853186-oss_labs_reengineering_p_s)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=7853186-oss_labs_reengineering_p_s&metric=coverage)](https://sonarcloud.io/summary/new_code?id=7853186-oss_labs_reengineering_p_s)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=7853186-oss_labs_reengineering_p_s&metric=bugs)](https://sonarcloud.io/summary/new_code?id=7853186-oss_labs_reengineering_p_s)[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=ppanchen_NetSdrClient&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=ppanchen_NetSdrClient)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=7853186-oss_labs_reengineering_p_s&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=7853186-oss_labs_reengineering_p_s)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=7853186-oss_labs_reengineering_p_s&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=7853186-oss_labs_reengineering_p_s)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=7853186-oss_labs_reengineering_p_s&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=7853186-oss_labs_reengineering_p_s)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=7853186-oss_labs_reengineering_p_s&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=7853186-oss_labs_reengineering_p_s)
...
jobs:
  sonar-check:
    ...
    steps:
      ...
      - name: SonarScanner Begin
        run: |
          ...
          dotnet sonarscanner begin `
            /d:sonar.projectKey="7853186-oss_labs_reengineering_p_s" `
            /d:sonar.organization="7853186-oss" `
      ...
      # Uncomment if you add tests later
